...
- Otherwise, spawn ``examples/voice_pipecat_bot/bot.py`` as a subprocess,
...
different bot (e.g. ``voice_pipecat_twilio_bot.py``) don't get hijacked.
"""
...
logger = logging.getLogger("voice_pipecat_bot.lifecycle")

DEFAULT_BOT_HOST = "127.0.0.1"
DEFAULT_BOT_PORT = 8765
DEFAULT_BOT_PATH = Path(__file__).resolve().parent / "voice_pipecat_bot" / "bot.py"
