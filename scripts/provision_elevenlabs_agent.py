...
def _create_agent(api_key: str) -> str:
    ...
    payload = {
        ...
        "conversation_config": {
            ...
            # Turn-taking is NOT tuned here — the adapter's 1.5s trailing silence
            # closes scripted turns reliably on a vanilla agent (issue #705); no
            # agent-side turn config needed.
        },
