...
Committed WAV fixtures (`javascript/examples/vitest/recordings/`, `python/recordings/`)
...
is acceptable. Track footprint via: `du -sh javascript/examples/vitest/recordings/ python/recordings/`.
