...
Committed WAV fixtures (`javascript/examples/vitest/outputs/`, `python/recordings/`)
...
is acceptable. Track footprint via: `du -sh javascript/examples/vitest/outputs/ python/recordings/`.
