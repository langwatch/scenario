...
Use Scenario in combination with evals to guarantee the 3 levels of agent quality:
...
Use Scenario to change your agent prompts, tools, and structure without worrying about regressions. You don't need a dataset, and Scenario works with all AI Agent frameworks.
...
Learn how to write effective [scenarios](/basics/writing-scenarios), explore [agent integrations](/agent-integration) for LangGraph, CrewAI, and Pydantic AI, or dive into [testing guides](/testing-guides/tool-calling) for tool calling and fixtures.
