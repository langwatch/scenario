...
See [Choosing an Adapter](/voice/choosing-an-adapter) for constructor signatures and worked examples for each.
...
- [Choosing an adapter](/voice/choosing-an-adapter) — pick the adapter for your stack (Twilio, Pipecat, ElevenLabs, Gemini Live)
