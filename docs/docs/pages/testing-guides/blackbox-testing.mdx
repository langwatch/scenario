...
- [Domain-Driven TDD](/testing-guides/domain-driven-tdd) - Using blackbox tests to drive implementation
- [Agent Testing Pyramid](/best-practices/the-agent-testing-pyramid) - Where blackbox tests fit
