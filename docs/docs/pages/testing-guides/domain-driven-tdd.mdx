...
Combines [Test-Driven Development](https://martinfowler.com/bliki/TestDrivenDevelopment.html) with [Domain-Driven Design](https://martinfowler.com/bliki/DomainDrivenDesign.html): write scenarios in business language first, watch them fail, implement minimally, then refactor to reveal domain concepts.
...
Run test. Fails: `Error: connect ECONNREFUSED`. This tells you what to build.
...
class FlightBooking {
  constructor(public origin: AirportCode, public destination: AirportCode) {}
}
...
- [Blackbox Testing](/testing-guides/blackbox-testing) - Testing via public interfaces
- [Testing Remote Agents](/examples/testing-remote-agents) - HTTP adapter patterns
- [Writing Scenarios](/basics/writing-scenarios) - Crafting effective scenarios
