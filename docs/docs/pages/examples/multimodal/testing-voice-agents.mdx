...
<CollapsibleCodeGroup defaultHeight={600}>
  <CodeTab title="audio ➜ text (typescript)" language="typescript">
    <AudioToTextExample />
  </CodeTab>
  <CodeTab title="audio ➜ audio (typescript)" language="typescript">
    <AudioToAudioExample />
  </CodeTab>
  <CodeTab
    title="voice-to-voice conversation (typescript)"
    language="typescript"
  >
    <VoiceToVoiceExample />
  </CodeTab>
  <CodeTab title="voice-to-voice conversation (python)" language="python">
