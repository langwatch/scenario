...
import JsonTestExample from "../../_generated/examples/testing-remote-agents-json.test.mdx";

# JSON Response Pattern

Test agents that return complete JSON responses via HTTP POST requests. This is the most common pattern for REST APIs.
...
- [Streaming Pattern](/examples/testing-remote-agents/streaming) - For chunked responses
