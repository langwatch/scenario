...
[Mastra](https://mastra.ai/) agents integrate with Scenario through the <RefLink link={{typescript: "classes/AgentAdapter.html" }} code={{ typescript: "AgentAdapter" }} /> interface. Manage conversation history and handle iterative agent execution.
