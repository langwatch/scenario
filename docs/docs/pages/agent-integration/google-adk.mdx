...
[Google ADK](https://google.github.io/adk-docs/) agents integrate with Scenario through the <RefLink link={{ python: "agent_adapter.html#scenario.agent_adapter.AgentAdapter" }} code={{ python: "AgentAdapter" }} /> interface. Manage the ADK session service and runner properly.
