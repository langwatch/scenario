...
[LangGraph](https://www.langchain.com/langgraph) agents integrate with Scenario through the <RefLink link={{ python: "agent_adapter.html#scenario.agent_adapter.AgentAdapter" }} code={{ python: "AgentAdapter" }} /> interface. Handle LangGraph's streaming responses and message conversion properly.
