...
[LiteLLM](https://github.com/BerriAI/litellm) agents integrate with Scenario through the <RefLink link={{ python: "agent_adapter.html#scenario.agent_adapter.AgentAdapter" }} code={{ python: "AgentAdapter" }} /> interface. LiteLLM provides a unified interface to 100+ LLMs, enabling agent testing across different models.
