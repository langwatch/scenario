...
[Inngest AgentKit](https://agentkit.inngest.com/) provides tools to build multi-agent systems and orchestrate them in an event-driven architecture.

AgentKit agents integrate with Scenario through the <RefLink link={{typescript: "classes/AgentAdapter.html" }} code={{ typescript: "AgentAdapter" }} /> interface.
