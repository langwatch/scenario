---
title: Red Teaming Reports
description: Open the interactive Streamlit dashboard over your red-team JSON reports, with findings, transcripts, severity, and prioritized fixes.
---
