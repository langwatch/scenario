...
Run your usual test command, or just ask your coding assistant to run it and monitor it for you. Red team runs are long — 50 turns can take several minutes — so make sure your runner's per-test timeout is generous.
