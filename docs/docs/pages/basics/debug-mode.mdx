...
Use Debug mode to step through scenarios interactively, inspect agent responses, and intervene with your own inputs. This is invaluable for understanding how your agent behaves and debugging issues in complex conversations.
