...
export default defineConfig({
  ...
  traceWaitTimeoutMs: 60_000, // Optional, defaults to 60000
});
```
...
| `trace_wait_timeout`  | float        | 60.0    | Maximum seconds the judge waits at verdict time for remote traces to complete |
