...
<Callout type="note">
  The config file is only supported in the JavaScript implementation of Scenario.
</Callout>
...
<Callout type="note">
  The `scenario.configure()` function is only supported in the Python implementation of Scenario.
</Callout>
