...
| `min_turns`     | int                | None    | Minimum turns guaranteed before the judge may volunteer a verdict ([details](/basics/judge-agent#guaranteeing-a-minimum-number-of-turns)) |
