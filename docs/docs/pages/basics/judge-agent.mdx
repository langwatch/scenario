...
- [Judge Criteria, Script Assertions and Evaluators](/testing-guides/judge-assertions-and-evaluators) - When a check belongs on the judge, in a script step or on an evaluator
