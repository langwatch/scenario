...
export default defineConfig({
  test: {
    ...
    globalSetup: [
      '@langwatch/scenario/integrations/vitest/setup-global', // Required
    ],
    setupFiles: [
      'dotenv/config', // Optional, if you want to use dotenv to load env vars
      '@langwatch/scenario/integrations/vitest/setup', // Required
    ],
    reporters: [
      'default',
      new VitestReporter(), // Required
    ],
  },
});
