```typescript [multimodal-audio-to-audio.test]
// Source: https://github.com/langwatch/scenario/blob/main/javascript/examples/vitest/tests/multimodal-audio-to-audio.test.ts
