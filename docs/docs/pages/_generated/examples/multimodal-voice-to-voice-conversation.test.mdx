```typescript [multimodal-voice-to-voice-conversation.test]
// Source: https://github.com/langwatch/scenario/blob/main/javascript/examples/vitest/tests/multimodal-voice-to-voice-conversation.test.ts
/**
