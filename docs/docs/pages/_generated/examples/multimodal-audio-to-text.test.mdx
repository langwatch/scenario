```typescript [multimodal-audio-to-text.test]
// Source: https://github.com/langwatch/scenario/blob/main/javascript/examples/vitest/tests/multimodal-audio-to-text.test.ts
