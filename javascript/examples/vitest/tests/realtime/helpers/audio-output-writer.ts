...
const saveTestAudio = async (
  ...
  outputDir: string = "test-audio-output"
): Promise<void> => {
 ...
 */
export const AudioOutputWriter = {
  /**
   ...
   *
   * @param collectedAudio - Array of audio response events to save
   * @param outputDir - Directory to save audio files (defaults to "test-audio-output")
   */
  saveTestAudio,
};
